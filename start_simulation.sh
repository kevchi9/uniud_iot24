...
FILES=("source_data/electrics_to_serial.txt" "source_data/gps_to_serial.txt" "source_data/file3.txt")
PORTS=("/dev/mypty/ptySENS1" "/dev/mypty/ptySENS2" "/dev/mypty/ptySENS3")
